---
name: taste-skill
description: "Use this for any frontend task where design is the point — building landing pages, portfolios, hero sections, brand pages, or overhauling how existing pages look. Also use for design audits: checking typography, spacing, color, contrast, layout, responsive behavior, and brand consistency. The trigger is visual intent — the user talks about how something should look, feel, be styled, or be made premium/professional/minimalist. Ignore for backend, APIs, deployment, scripts, code review, bug fixes, and non-visual programming."
user-invocable: true
allowed-tools:
  - Read
  - Bash(git *)
  ...
  - Bash(rg *)
  - Bash(jq *)
  - Bash(node .claude/skills/taste-skill/scripts/*)
---
...
### 5.A–5.D Code Skeletons & Forbidden Animation Patterns

> **Reference:** [`reference/code-skeletons.md`](reference/code-skeletons.md) — canonical implementations for Sticky-Stack, Horizontal-Pan, Scroll-Reveal Stagger, and forbidden animation patterns. Load when implementing GSAP/Motion animations.
...
> **Reference:** [`reference/ai-tells.md`](reference/ai-tells.md) — complete catalog of forbidden visual, typography, layout, content, and production-test patterns. Includes the non-negotiable EM-DASH BAN (Section 9.G). Load when self-auditing or pre-flighting output.

---

## 10. REFERENCE VOCABULARY (Pattern Names)

> **Reference:** [`reference/pattern-vocabulary.md`](reference/pattern-vocabulary.md) — full catalog of pattern names: Hero Paradigms, Navigation & Menus, Layout & Grids, Cards & Containers, Scroll Animations, Galleries & Media, Typography & Text, Micro-Interactions & Effects, and Animation Library Choice. Load when designing section layouts or choosing interaction patterns.
...
> **Script:** `node .claude/skills/taste-skill/scripts/detect.mjs [--json] [paths...]` — automated AI-slop scanner. Run before manual checklist to catch em-dashes, gradient text, Inter default, eyebrow overuse, nested cards, and 10+ other patterns. Exit code 1 = slop found.
>
> **Reference:** [`reference/preflight-checklist.md`](reference/preflight-checklist.md) — complete 60+ item checklist. Run every box before shipping. If any box fails, the output is not done.

---

# APPENDICES

> **Reference:** [`reference/appendices.md`](reference/appendices.md) — install commands per design system (Appendix A), canonical doc links (Appendix B), and Apple Liquid Glass honest web approximation (Appendix C). Load when picking a design system from Section 2 or verifying install commands.
