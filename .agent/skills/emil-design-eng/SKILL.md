...
source: https://github.com/emilkowalski/skill — public domain / freely distributable
trigger: on-demand — invoke per task, not always active (author recommendation)
user-invocable: true
allowed-tools:
  - Read
  - Bash(git *)
...
> **Reference:** [`reference/css-techniques.md`](reference/css-techniques.md) — CSS Transform Mastery, clip-path for Animation, Gesture and Drag Interactions. Load when implementing specific CSS techniques or gesture handling.
>
> **Reference:** [`reference/performance-and-debugging.md`](reference/performance-and-debugging.md) — Performance Rules (GPU acceleration, CSS vs JS, WAAPI), Debugging Animations (slow motion, frame-by-frame, real device testing). Load when optimizing or debugging animations.
...
> **Reference:** [`reference/performance-and-debugging.md`](reference/performance-and-debugging.md) — slow motion testing, frame-by-frame inspection, real device testing, next-day review.
