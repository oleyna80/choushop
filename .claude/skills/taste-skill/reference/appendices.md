...
Reference material vendored from official docs. Load when picking a design system (Section 2) or verifying install commands.
...
A web approximation can use: `backdrop-filter`, transparent backgrounds, layered borders, highlight overlays, gradients, motion, strong contrast fallbacks. Label it as such in comments.
...
.liquid-glass-web-approx::before { /* highlight */ }
.liquid-glass-web-approx::after { /* inner border */ }

@media (prefers-color-scheme: dark) {
  .liquid-glass-web-approx { /* dark variant */ }
}
